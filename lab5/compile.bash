#!/bin/bash
# filepath: /home/gefgu/repos/riscv-microprocessor/lab5/compile.bash

# Set the working directory to lab5
cd "$(dirname "$0")"
...
echo -e "${GREEN}Starting compilation of RISC-V processor...${NC}"
...
# Step 4: Compile the processador and testbench
echo -e "${GREEN}Compiling lab5 files...${NC}"
ghdl -a processador.vhd || { echo -e "${RED}Failed to compile processador${NC}"; exit 1; }
ghdl -a processador_tb.vhd || { echo -e "${RED}Failed to compile processador_tb${NC}"; exit 1; }

# Step 5: Build the executable
echo -e "${GREEN}Building the executable...${NC}"
ghdl -e processador_tb || { echo -e "${RED}Failed to build the executable${NC}"; exit 1; }
...
echo -e "${GREEN}You can view the waveform using GTKWave: gtkwave processador_tb.ghw${NC}"