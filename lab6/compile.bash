#!/bin/bash
# filepath: /home/gefgu/repos/riscv-microprocessor/lab6/compile.bash

# Set the working directory to lab6
cd "$(dirname "$0")"
...
echo -e "${GREEN}Starting compilation of RISC-V processor for lab6...${NC}"

# Step 1: Compile the library components from lab2 first
...
# Step 5: Compile the lab6 components and testbench
echo -e "${GREEN}Compiling lab6 files...${NC}"
ghdl -a reg1bit.vhd || { echo -e "${RED}Failed to compile reg1bit${NC}"; exit 1; }
ghdl -a flag_registers.vhd || { echo -e "${RED}Failed to compile flag_registers${NC}"; exit 1; }
ghdl -a processador_lab6_tb.vhd || { echo -e "${RED}Failed to compile processador_lab6_tb${NC}"; exit 1; }

# Step 6: Build the executable
echo -e "${GREEN}Building the executable...${NC}"
ghdl -a processador_lab6_tb.vhd || { echo -e "${RED}Failed to build the executable${NC}"; exit 1; }
...
echo -e "${GREEN}You can view the waveform using GTKWave: gtkwave processador_lab6_tb.ghw${NC}"