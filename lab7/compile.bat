...
ghdl -a RAM.vhd || goto :error

REM Passo 7: Compilar testbench
echo Compiling testbench...
ghdl -a processador_lab7_tb.vhd || goto :error

REM Passo 8: Construir o executável
echo Building the executable...
ghdl -e processador_lab7_tb || goto :error
...
echo You can view the waveform using GTKWave: gtkwave processador_lab7_tb.ghw
echo ============================================
pause
goto :eof
